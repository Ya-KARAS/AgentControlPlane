...
// @author       Ya-KARAS
// @downloadURL  https://acp.asterroute.com/downloads/agent-control-plane-web-bridge.user.js
...
const MESSAGES = Object.freeze({
  "zh-CN": Object.freeze({
    ...
    versionLabel: "ACP 当前版本 {version}",
    checkUpdates: "检查更新",
    languageApplied: "语言已切换",
    languageAppliedDetail: "界面和后续 ACP 任务将使用所选语言；已有网页 AI 回复不会被改写。",
    ready: "就绪",
  ...
  en: Object.freeze({
    ...
    versionLabel: "ACP current version {version}",
    checkUpdates: "Check for updates",
    languageApplied: "Language changed",
    languageAppliedDetail: "The interface and future ACP tasks will use the selected language. Existing web AI replies are not rewritten.",
    ready: "Ready",
